    ...
    <nav className="bg-white border-b border-gray-200 px-4 sm:px-6 py-4 sticky top-0 z-50">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
          <a
            href="/"
            className="px-3 py-2 xl:px-4 text-green-600 border-2 border-green-600 rounded-lg font-medium hover:bg-green-50 transition-colors text-sm xl:text-base"
          >
            Home
          </a>
          <a
            href="#"
            className="text-gray-600 font-medium hover:text-gray-800 transition-colors text-sm xl:text-base"
          >
            Listed Books
          </a>
          <a
      ...
      {isMenuOpen && (
        <div className="md:hidden mt-4 pb-4 border-t border-gray-200">
          <div className="flex flex-col space-y-3 pt-4">
            ...
            <a
              href="#"
              className="px-4 py-2 text-green-600 border-2 border-green-600 rounded-lg font-medium hover:bg-green-50 transition-colors text-center"
            ...
            <a
              href="#"
              className="px-4 py-2 text-gray-600 font-medium hover:text-gray-800 transition-colors text-center"
              onClick={() => setIsMenuOpen(false)}
            >
              Listed Books
            </a>
